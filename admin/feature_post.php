    ...
    <div class="content-padder content-background">
        <div class="uk-section-small uk-section-default header">
            <div class="uk-container uk-container-large">
                <h1><span class="ion-speedometer"></span> Upcoming Activity Edit </h1>
                <!--
                    <p>
...
-->
                <ul class="uk-breadcrumb">
                    ...
                    <li><span href="images.php">Upcoming Activity Edit</span></li>
                </ul>
            </div>
        </div>
                                ...
                                <table class="uk-table uk-table-responsive uk-table-divider">
                                    ...
                                    if ($num > 0) {
                                        ...
                                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            echo "<td><img src='uploads/articles/{$image}' width='60px' height='60px'></td>";
                                            echo "<td>{$created_on}</td>";
                                            echo "<td>{$status}</td>";
                                            echo "<td><a href='add-article.php?id={$id}&edit=true'>EDIT </td>";
