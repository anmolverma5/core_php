    ...
    if(isset($_POST['edit_value'])){
       ...
       $id= $_POST['id_edit'];
        ...
        else
        {
         ...
         $sql="UPDATE articles SET title ='$title',  categories='$categories', tags='$tags',
                                            ...
                                            <!-- <div class="uk-width-1-3">
                                              <label>Slug</label>
                                                <div class="uk-position-relative">
                                                    ...
                                                    <input name="slug" class="uk-input" type="text" placeholder="Slug" value="<?php if (isset($edit_slug)){echo $edit_slug;} ?>">
                                                </div>
                                            </div> -->
                                          ...
                                          <div class="uk-margin">
                                              ...
                                              <div class="uk-position-relative">
                                                 <!--  <span class="uk-form-icon ion-android-call"></span> -->
                                                  <textarea  name="description" id="txtEditor" class="ckeditor"><?php if (isset($description_edit)){echo $description_edit;} ?></textarea>
